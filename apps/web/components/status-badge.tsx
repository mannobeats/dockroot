const statusStyles: Record<string, { dot: string; text: string }> = {
	...
	unhealthy: { dot: "bg-rose-500", text: "text-rose-700 dark:text-rose-400" },
	...
	starting: { dot: "bg-amber-500 pulse-dot", text: "text-amber-700 dark:text-amber-400" },
...
export function StatusBadge({ status }: { status: string }) {
	...
	return (
		<span
			className={`inline-flex items-center gap-1.5 text-[11px] font-medium capitalize ${style.text}`}
		>
